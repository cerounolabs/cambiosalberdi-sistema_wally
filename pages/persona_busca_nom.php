                    ...
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h1 class="page-title" style="font-size:2.19rem !important;">
                                ...
                                GEOLOCALIZACI&Oacute;N DE PERSONA X NOMBRE
                            </h1>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample">
                                            <div class="form-group">
                                                <label for="persona"> APELLIDO O NOMBRE O RAZ&Oacute;N SOCIAL </label>
                                                <input type="text" class="form-control" style="text-transform:uppercase;" id="persona" name="persona" placeholder="APELLIDO O NOMBRE O RAZ&Oacute;N SOCIAL">
                                            </div>
...
<?php
    ...
    if (isset($_GET['persona'])) {
        $arr_persona = getPersNombre($_GET['persona']);
        ...
        <script>
            function buscaPersona() {
                ...
                if (persona !== null && persona !== '') {
                    urlGET = "http://10.168.196.152/sistema_wally/pages/persona_busca_nom.php?persona=" + persona;
                } else {
                    urlGET = "http://10.168.196.152/sistema_wally/pages/persona_busca_nom.php";
                }
